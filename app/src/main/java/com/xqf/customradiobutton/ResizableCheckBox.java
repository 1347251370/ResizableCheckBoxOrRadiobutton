...
public class ResizableCheckBox extends CheckBox {

    private int mDrawableHeight;//xml文件中设置的高度
    private int mDrawableWidth;//xml文件中设置的宽度

    public ResizableCheckBox(Context context) {
        this(context, null, 0);
    }

    public ResizableCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ResizableCheckBox(Context context, AttributeSet attrs, int defStyle) {
